...
export const Route = createFileRoute("/")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      { title: "FinRoute — Digital Collection Book for Finance Businesses" },
      { name: "description", content: "Run daily, weekly and monthly lending like a modern SaaS. Free digital collection book, smart loan calculator, GPS-tracked field collections and beautiful reports." },
      { property: "og:title", content: "FinRoute — Modern ERP for Finance" },
      { property: "og:description", content: "Replace paper notebooks with a beautiful digital collection book. Free forever." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "/" },
      { property: "og:image", content: loaderData?.imageUrl ?? ogImage.url },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "FinRoute dashboard preview for Indian finance businesses" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FinRoute — Modern ERP for Finance" },
      { name: "twitter:description", content: "Replace paper notebooks with a beautiful digital collection book. Free forever." },
      { name: "twitter:image", content: loaderData?.imageUrl ?? ogImage.url },
